    ...
    export class MenuScreen extends CanvasScreen
    {
        ...
        public constructor(app: App)
        {
            ...
            this.entries = [
                ...
                new MenuScreenEntry(180, App.LOGO, "res/imgs/menu_todo.png"),
                new MenuScreenEntry(240, App.LOGO, "res/imgs/menu_todo.png"),
                new MenuScreenEntry(300, App.LOGO, "res/imgs/menu_todo.png"),
            ];
        }
