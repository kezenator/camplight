namespace bbox.debug
{
    export class OutputView extends bbox.ui.Control
    {
        ...
        public addDebugReport(report: api.DebugReport): void
        {
            var div = document.createElement('div');
            div.classList.add('output-view-item');
        ...
        public addQueryResponse(entry: api.QueryResponseEntry): void
        {
            var div = document.createElement('div');
            div.classList.add('output-view-item');
            ...
            {
                var child: api.ChildEntry = entry.children.at(j);
