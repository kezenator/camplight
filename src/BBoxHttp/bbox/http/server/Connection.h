 ...
 * @file
 *
 * Header for the bbox::http::server::Connection class.
 */

#ifndef __BBOX__RT__HTTP__SERVER__CONNECTION_H__
#define __BBOX__RT__HTTP__SERVER__CONNECTION_H__
...
#endif // __BBOX__RT__HTTP__SERVER__CONNECTION_H__
